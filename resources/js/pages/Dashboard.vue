...
import CustomersDemographic from '@/components/CustomersDemographic.vue';
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4 overflow-x-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <StatCard title="Orders" value="5,359" :trend="-9.05" :icon="Box" class="col-span-1 row-span-1" />

                <MonthlyTarget class="col-span-2 row-span-2" />

                <div class="col-span-2 row-start-2 bg-white rounded-xl p-6 shadow">
                    <MonthlySalesChart class="col-span-2 row-span-2" />
                </div>
            </div>
